...
tf.flags.DEFINE_string("filter_sizes", "3,4,5", "Comma-seperated filter sizes (default: '3,4,5')")
...
tf.flags.DEFINE_integer("checkpoint_every", 100, "Save model after this may steps (deafult: 100)")
...
def preprocess():
	...
	print("Loading data ...")
	x_text, y = data_utils.load_data_and_lables(FLAGS.pos_data_file, FLAGS.neg_data_file)
